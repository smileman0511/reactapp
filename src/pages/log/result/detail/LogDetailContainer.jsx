...
const LOG_DATA = {
  ...
  badges: [
    ...
    { label: "공부/취업",  color: theme.PALETTE.primary.main, bg: theme.PALETTE.primary.extraLight },
  ],
      ...
      <S.MetaRow>
        ...
        <S.LikeButton onClick={handleLike} $liked={liked}>
          <S.HeartIcon $liked={liked}>
            <svg width="25" height="22" viewBox="0 0 25 22" fill={liked ? theme.PALETTE.red : "none"} xmlns="http://www.w3.org/2000/svg">
              <path 
                ...
                stroke={liked ? theme.PALETTE.red : "#333333"} 
                strokeWidth="1.55556" 
                strokeLinecap="round" 
...
S.Card = styled.div`
  ...
  border-left: 6px solid ${theme.PALETTE.third.main};
  border-radius: 0 12px 12px 12px;
  padding: 60px 80px; /* Increased padding */
  position: relative;
  z-index: 1;
  width: 1276px; /* Fixed width from Figma */
  min-height: 1171px; /* Fixed height from Figma */
  display: flex;
